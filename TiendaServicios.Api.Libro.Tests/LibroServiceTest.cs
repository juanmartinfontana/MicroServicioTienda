...
namespace TiendaServicios.Api.Libro.Tests
{
    public class LibroServiceTest
    {
        ...
        private Mock<ContextoLibreria> CrearContexto()
        {
            ...
            //Propiedades que debe tener el EF
        ...
        public async void GetLibroById()
        {
            ...
            var manejador = new ConsultaFiltro.Manejador(contexto.Object, mapper);
        ...
        public async void GetLibros()
        {
            ...
            //3 Instanciar a la clase manejador y pasarle como parametros los mocks que creamos
